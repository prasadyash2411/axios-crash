...
function getTodos() {
  ...
  // just axios is enough because it takes get request by default
...
// PUT/PATCH REQUEST
//put will update entire resource where as patch will update incrementally
function updateTodo() {
...
// SIMULTANEOUS DATA
//get posts and todos at once  we can use axios.all
function getData() {
  // axios.all([
  ...
  //   showOutput(res[1]);
  // })
  //use axios.spread inside then for better use of variables and better naming
